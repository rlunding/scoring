...
class TestSignup(ViewTestMixin):
    ...
    def test_welcome(self, users):
        """ Create fullname and room number successfully. """
        self.login()

        user = {'fullname': 'hello', 'room': 10}
    ...
    def test_welcome_with_existing_username(self, users):
        """ Create fullname failure due to fullname already existing. """
        self.login()
        ...
        assert_status_with_message(200, response,
                                   'You already gave your name and room.')
